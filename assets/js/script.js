$(document).ready(function() {
    ...
    $("#btn-transport").on("click", function(){
        ...
        var selectedCity = $( "#selectCityList option:selected" ).text();
        $("#inputCity").val(selectedCity);
    });
...
var selectMotor = function(el) {
    var selectedItem = $(el).attr("motor");
    $("#callback-modal5").modal('show');
    $("#inputMotor5").val(selectedItem);
}